    ...
    const template = [
        {
            id: "classic",
            name: "Classic",
            preview: "A clear, traditional resume format with clear section and professional typography" 
        },
        {
            id: "modern",
            name: "Modern",
        ...
        },
        {
            id: "minimal",
            name: "Minimal",
            preview: "Ultra-clean design that puts yous content front and center" 
        },
    ]
  return (
