      ...
      <header className='bg-black text-white flex flex-col items-center bg-[url("https://assets.prebuiltui.com/images/components/hero-section/hero-background-image.png")] bg-cover bg-center bg-no-repeat pb-10'>
        <nav className="flex flex-col items-center w-full">
          <div className="flex items-center justify-between p-4 md:px-16 lg:px-24 xl:px-32 md:py-4 w-full">
            <a className="text-3xl font-bold cursor-pointer">ResumeAI</a>
            <div
              id="menu"
            ...
            >
              <a
                ...
                className="text-white/70 hover:text-green-600"
              >
                Home
              </a>
              <a
              ...
              <a
                href="#contact"
                onClick={() => setMobileOpen(false)}
                className="text-white/70 hover:text-green-600 mr-6"
              >
                Contact
              </a>
        ...
        {/* Hero Section */}
        <div className="rainbow relative z-0 bg-white/15 overflow-hidden p-px flex items-center justify-center rounded-full transition duration-300 active:scale-100 mt-15">
          <button className="flex items-center justify-center gap-3 pl-4 pr-6 py-3 text-white rounded-full font-medium bg-gray-900/80 backdrop-blur">
            ...
            <span className="text-xs">Create Resume in Minutes</span>
          </button>
        </div>
        ...
        <p className="text-sm text-gray-300 text-center max-w-lg mt-4.5">
          Create, edit and download professional resume with AI-powered
          assistance.
        </p>

        <div className="hidden md:block space-x-3 mt-10">
          <Link
            to="/app?state=register"
            className="px-6 py-2 bg-indigo-600 hover:bg-indigo-700 transition text-white rounded-md"
          >
