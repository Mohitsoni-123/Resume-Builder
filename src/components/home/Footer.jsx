      ...
      <footer className="bg-black text-white py-12 md:py-16 px-4 sm:px-6 md:px-8 lg:px-20">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-6 gap-8 md:gap-16">
          <div className="lg:col-span-3 space-y-6">
            <a className="text-2xl font-bold bg-gradient-to-r from-[#A992F2] to-[#DFAB9B] bg-clip-text text-transparent">
              ResumeAI
            </a>
            <p className="text-sm md:text-base mt-3">
              Transform your career with AI-powered resume building. Create professional, ATS-friendly resume that get noticed by recruiters.
            </p>
